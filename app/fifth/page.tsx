...
export default function Home() {
  const song = "The Tortured Poets Department";
  const artist = "Taylor Swift";
  const image = "/assets/TaylorSwift_TTPD.jpeg";
  const explanation = (
    <div>
      <h1 className="text-xl font-bold mb-1">Glucose: {song}</h1>
      <p className="text-base mb-4">
        Glucose is the end product of photosynthesis, fueling the plant’s growth
        and serving as an energy reserve. The lyric "You smoked then ate seven
        bars of chocolate" ties in glucose-rich chocolate as a relatable analogy
        for the sugar plants produce.
      </p>
      <h2 className="text-lg font-semibold">Scientific Role:</h2>
      <ul className="list-disc list-outside pl-5">
        <li>
          <strong>Energy Storage:</strong> Glucose is stored as starch in plants
          for future use, especially during periods without sunlight.
        </li>
        <li>
          <strong>Building Block:</strong> Glucose is also used to form
          cellulose, the structural material in plant cell walls.
        </li>
        <li>
          <strong>Energy Transfer:</strong> Through cellular respiration,
          glucose provides energy for plants to grow, flower, and reproduce.
        </li>
      </ul>
    </div>
  );
        ...
        {!isCorrect && (
          <div className="items-center flex justify-center w-full flex-col">
            ...
            <div className="mt-4 flex justify-center w-full">
              <AudioPlayer audioSrc="/audio/clip5.mp3" />
            </div>
