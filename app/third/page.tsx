...
export default function Home() {
  ...
  const image = "/assets/TaylorSwift_Clean.jpeg";
  const explanation = (
    <div>
      <h1 className="text-xl font-bold mb-1">Water: {song}</h1>
      <p className="text-base mb-4">
        Water flows through the plant, just as Taylor sings of cleansing and
        renewal in "Clean." The lyric's flood imagery reflects the life-giving
        role of water in photosynthesis.
      </p>
      <h2 className="text-lg font-semibold">Scientific Role:</h2>
      <ul className="list-disc list-outside pl-5">
        <li>
          <strong>Source of Hydrogen:</strong> Water molecules (H₂O) are split
          into hydrogen and oxygen during the light-dependent reactions of
          photosynthesis.
        </li>
        <li>
          <strong>Oxygen Production:</strong> Oxygen from the water is released
          into the atmosphere as a byproduct, essential for the survival of most
          organisms.
        </li>
        <li>
          <strong>Transportation:</strong> Water also carries dissolved
          nutrients from the roots to the leaves, ensuring the plant has
          everything it needs to perform photosynthesis.
        </li>
      </ul>
    </div>
  );
        ...
        {!isCorrect && (
          <div className="items-center flex justify-center w-full flex-col">
            ...
            <div className="mt-4 flex justify-center w-full">
              <AudioPlayer audioSrc="/audio/clip3.mp3" />
            </div>
