...
export default function Home() {
  ...
  const image = "/assets/TaylorSwift_Breathe.jpeg";
  const explanation = (
    <div>
      <h1 className="text-xl font-bold mb-1">Oxygen: {song}</h1>
      <p className="text-base mb-4">
        Oxygen is the life-giving byproduct of photosynthesis. In "Breathe,"
        Taylor's lyric "And I can't breathe without you but I have to"
        highlights the indispensable role of oxygen in sustaining life.
      </p>
      <h2 className="text-lg font-semibold">Scientific Role:</h2>
      <ul className="list-disc list-outside pl-5">
        <li>
          <strong>Water Splitting:</strong> Oxygen is released during the
          light-dependent reactions when water molecules are split by energy
          from sunlight.
        </li>
        <li>
          <strong>Ecosystem Dependency:</strong> Animals, humans, and other
          aerobic organisms depend on this oxygen for respiration.
        </li>
        <li>
          <strong>Global Impact:</strong> Plants are crucial for maintaining
          atmospheric oxygen levels, making them the “lungs” of the planet.
        </li>
      </ul>
    </div>
  );
        ...
        {!isCorrect && (
          <div className="items-center flex justify-center w-full flex-col">
            ...
            <div className="mt-4 flex justify-center w-full">
              <AudioPlayer audioSrc="/audio/clip6.mp3" />
            </div>
